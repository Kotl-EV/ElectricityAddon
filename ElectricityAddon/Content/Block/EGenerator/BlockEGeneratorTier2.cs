...
public class BlockEGeneratorTier2 : Vintagestory.API.Common.Block, IMechanicalPowerBlock
{
    ...
    {
        base.OnUnloaded(api);
        BlockEGeneratorTier2.MeshData.Clear();
    }
        ...
        Vintagestory.API.Common.Block[] chunkExtBlocks, int extIndex3d)
    {
           ...
           )
        {
            ...
            if (!BlockEGeneratorTier2.MeshData.TryGetValue(facing, out var meshData))
            {
                ...
                BlockEGeneratorTier2.MeshData.Add(facing, meshData);
            }

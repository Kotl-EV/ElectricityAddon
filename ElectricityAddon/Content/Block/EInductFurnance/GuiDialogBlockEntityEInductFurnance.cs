...
public class GuiDialogBlockEntityEInductFurnance : GuiDialogBlockEntity
{
    ...
    public GuiDialogBlockEntityEInductFurnance(string dialogTitle, InventoryBase Inventory, BlockPos BlockEntityPosition,
    ...
    private void OnBgDraw(Context ctx, ImageSurface surface, ElementBounds currentBounds)
    {
        ...
        double dy = 210 - 210 * (Attributes.GetFloat("stoveTemperature") / 3000);

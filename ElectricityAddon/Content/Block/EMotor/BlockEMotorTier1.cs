...
public class BlockEMotorTier1 : Vintagestory.API.Common.Block, IMechanicalPowerBlock
{
    ...
    {
        base.OnUnloaded(api);
        BlockEMotorTier1.MeshData.Clear();
    }
            ...
            entity.Eparams = (new float[7]
                        {
                            ...
                            0,                                  //напр€жение (возможно будет про запас)
                            0,                                  //сгорел или нет
                            32                                  //напр€жение
                         },
        ...
        Vintagestory.API.Common.Block[] chunkExtBlocks, int extIndex3d)
    {
           ...
           )
        {
            ...
            if (!BlockEMotorTier1.MeshData.TryGetValue(facing, out var meshData))
            {
                ...
                BlockEMotorTier1.MeshData.Add(facing, meshData);
            }

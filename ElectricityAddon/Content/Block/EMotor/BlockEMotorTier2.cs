...
public class BlockEMotorTier2 : Vintagestory.API.Common.Block, IMechanicalPowerBlock
{
    ...
    {
        base.OnUnloaded(api);
        BlockEMotorTier2.MeshData.Clear();
    }
        ...
        Vintagestory.API.Common.Block[] chunkExtBlocks, int extIndex3d)
    {
           ...
           )
        {
            ...
            if (!BlockEMotorTier2.MeshData.TryGetValue(facing, out var meshData))
            {
                ...
                BlockEMotorTier2.MeshData.Add(facing, meshData);
            }
